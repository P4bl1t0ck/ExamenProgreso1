...
namespace ExamenProgreso1.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public MascotasController(VeterinariaBasedeDatos context)
        {
            _context = context;
        }
        ...
        {
            var veterinariaBasedeDatos = _context.Mascota.Include(m => m.Dueno);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,cumple,aspecto,pablomontalvo,DuenoId")] Mascota mascota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,cumple,aspecto,pablomontalvo,DuenoId")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
